...
describe 'API' do
  ...
  context 'search by tags' do
    ...
    it 'should return documents matching a single tag' do
      get URI.escape('/api/soupcms-test/posts?tags=tag1&filters[]=tags')
    ...
    it 'should return documents matching multiple tags' do
      get URI.escape('/api/soupcms-test/posts?tags[]=tag3&tags[]=tag4&filters[]=tags')
    ...
    it 'should resolve tags with label and link' do
      ...
      expect([documents[0]['tags'][0]['link']['url'],documents[0]['tags'][1]['link']['url']]).to match_array([URI.escape('http://localhost:9292/soupcms-test/posts?tags=tag1'), URI.escape('http://localhost:9292/soupcms-test/posts?tags=tag2')])
    end
