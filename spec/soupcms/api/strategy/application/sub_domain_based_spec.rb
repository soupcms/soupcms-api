...
describe SoupCMS::Api::Strategy::Application::SubDomainBased do

  let(:app_strategy) { SoupCMS::Api::Strategy::Application::SubDomainBased.new(Rack::Request.new(Rack::MockRequest.env_for('http://soupcms-test.example.com:8080/api/posts/slug/my-first-blog-post?include=drafts'))) }
